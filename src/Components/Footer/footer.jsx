...
import './footer.css'
import './footer.scss'
import video2 from  '../../Data/footer.mp4'
      ...
      <div className="seeContent container">
        ...
        <div className="footerCard flex">
          <div className="footerIntro flex">
            <div className="logoDiv">
              <a href="" className="logo flex">
                <MdOutlineModeOfTravel className='icon'/> Travel.</a>
            </div>

            <div data-aos='fade-up' className="footerPara">
              Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sit culpa dolores velit sequi, aperiam tempore architecto doloremque dignissimos suscipit. Voluptate quas tenetur obcaecati possimus assumenda?
            </div>
          ...
          <div className="footerDiv flex">
            ...
            <small>COPYRIGHTS RESERVED - HASTI MACHHI 2024</small>
          </div>
        </div>
      </div>
